...
def balanced(m):
    ...
    # print("DEBUG:",left_arm,right_arm)
    length_l = length(left_arm)
    length_r = length(right_arm)
    mass_l = total_mass(end((left_arm)))
    mass_r = total_mass(end((right_arm)))
    # print("DEBUG:",length_l,length_r,mass_l,mass_r)
    if length_l*mass_l == length_r * mass_r:
        return True
    else:
        return False
